...
- For `.xlsx`: there are no images by default. If you want a header logo on every page, drop the logo PNG from `../03-original-templates/NextDecade Blank Procedure Template_Rev 1 April 9th 2026.docx → word/media/imageN.png` into the worksheet header.
